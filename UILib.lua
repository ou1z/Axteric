...
function Axteric:Init(name, config)
	...
	function Master:CreateTab(name)
		...
		function self:Label(name)
			local LabelFrame = Instance.new("Frame")
			local TextLabel = Instance.new("TextLabel")

			LabelFrame.Name = "LabelFrame"
			LabelFrame.Parent = game.StarterGui.Old.Frame.Frames.TabFrame
			LabelFrame.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
			LabelFrame.BackgroundTransparency = 1.000
			LabelFrame.Position = UDim2.new(-0.125313282, 0, 0.020833334, 0)
			LabelFrame.Size = UDim2.new(0.716791987, 100, 0, 34)
